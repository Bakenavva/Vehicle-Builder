...
class Cli {
    ...
    inquirer
      ...
      .then((answers) => {
        const motorbike = new Motorbike(
          ...
          parseInt(answers.weight),
          parseInt(answers.topSpeed),
          // custom returns for tires, as the inquirer prompt is more direct for motorbikes
          [
            new Wheel(
  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        // Checks if vehicle can tow another vehicle; logic ensures it cannot tow itself
